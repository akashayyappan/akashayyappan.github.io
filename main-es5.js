...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _component_error_error_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var node_modules_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! node_modules/validator */
    "./node_modules/validator/index.js");
    /* harmony import */


    var node_modules_validator__WEBPACK_IMPORTED_MODULE_4___default =
    /*#__PURE__*/
    __webpack_require__.n(node_modules_validator__WEBPACK_IMPORTED_MODULE_4__);

    var AppComponent =
    /*#__PURE__*/
    function () {
      function AppComponent(cs, fb) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          //modal window
          this.cs._modal.subscribe(function (data) {
            _this.modal = data;

            _this.cs.setEnableLoginWindow(false);
          }); //login window


          this.cs._enableLoginWindow.subscribe(function (data) {
            _this.loginWindow = data;
          });

          this.cs._isLoggedIn.subscribe(function (data) {
            _this.isUserLoggedIn = data;
          });
          ...
          this.cs._infoMessage.subscribe(function (msg) {
            if (!msg["msg"]) return;
            if (msg["type"]) _this.infoMessageType = true;else _this.infoMessageType = false;
            _this.infoMessage = msg["msg"];
          ...
          if (window.localStorage.getItem("token")) {
            this.cs.webServiceCall("get", "user/check").subscribe(function (data) {
              _this.cs.setUser(data);

              _this.cs.setUserLoggedIn(true);

              _this.cs.showInfoMessage("Logged in using last used credentilas", true);
            });
          }
        }
      }, {
        key: "validateEmail",
        value: function validateEmail(con) {
        ...
        value: function onLoginFormSubmit() {
          ...
          this.cs.webServiceCall("post", "user/login", this.loginForm.value).subscribe(function (data) {
            _this2.cs.setUserLoggedIn(true);

            _this2.cs.setUser(data);

            _this2.cs.setModal(false);
          }, function (err) {
            _this2.cs.setUserLoggedIn(false);
          });
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _component_error_error_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./component/error/error.component */
    "./src/app/component/error/error.component.ts");
    /* harmony import */


    var _service_common_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./service/common.service */
    "./src/app/service/common.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _component_error_error_component__WEBPACK_IMPORTED_MODULE_7__["ErrorComponent"]],
  ...
  /***/
  function srcAppComponentErrorErrorComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentErrorErrorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ErrorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./error.component.css */
      "./src/app/component/error/error.component.css")).default]
    })], ErrorComponent);
    /***/
  },
  ...
  function srcAppServiceCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(CommonService, [{
        key: "setModal",
        value: function setModal(val) {
          this._modal.next(val);
        }
      }, {
        key: "setEnableLoginWindow",
        value: function setEnableLoginWindow(val) {
          this._enableLoginWindow.next(val);
        }
      }, {
        key: "setUserLoggedIn",
        value: function setUserLoggedIn(val) {
        ...
        key: "showInfoMessage",
        value: function showInfoMessage(msg, type) {
          var message = {
            type: type,
            msg: msg
          };
        ...
        key: "webServiceCall",
        value: function webServiceCall(method, url, payload) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\MEAN Stack\GitHub\akashayyappan.github.io\Invoice\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
